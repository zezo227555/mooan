...
var options = {
    ...
    colors: ["rgba(132, 90, 223, 1)", '#9c52fd'],
};
...
var options2 = {
    ...
    colors: ["rgb(82, 92, 229)", "#9c52fd", "#f5b849"],
    background: 'transparent',
    dataLabels: {
        enabled: false
    },
...
function userSession() {
    chart4.updateOptions({
        colors: ["rgb(" + myVarVal + ")", "#9c52fd", "#f5b849"],
    })
}
/* Session Duration By New Users Chart */
