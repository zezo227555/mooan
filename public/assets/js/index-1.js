...
var options = {
    ...
    colors: [ "#ec447c", 'var(--primary-color)' ],
    };
    var chart = new ApexCharts(document.querySelector("#lead_break_down"), options);
    chart.render();
    /*Chart3 js*/

    
// $('.resp-tabs-list .home-Yoha').addClass('active');
// $('.second-sidemenu .home-Yoha').addClass('resp-tab-content-active');
  
   function bounce_widget() {
    var options = {
    series: [{
        data: [
          [1327359600000,30.95],
  ...
  document.querySelector("#bounce-widget").innerHTML= " ";
  var chart = new ApexCharts(document.querySelector("#bounce-widget"), options);
  chart.render();
}
...
var options = {
    ...
    colors: [ 'var(--primary-color)',"#ec447c", '#ffa70b', "#2f89f5"],
    };
