...
function switcherClick() {
  ...
  let lightThemeVar = lightBtn.addEventListener("click", () => {
    lightFn();
    localStorage.setItem("YohaHeader", "light");
    localStorage.setItem("YohaMenu", "light");
  });
  /* Light Layout End */
  ...
  let darkThemeVar = darkBtn.addEventListener("click", () => {
    darkFn();
    localStorage.setItem("YohaMenu", "dark");
    localStorage.setItem("YohaHeader", "dark");
  });
  /* Dark Layout End */
...
function lightFn() {
  ...
  updateColors();
  localStorage.removeItem("Yohadarktheme");
  checkOptions();
  // html.style.removeProperty('--primary-rgb');
}
...
function darkFn() {
  ...
  updateColors();
  localStorage.setItem("Yohadarktheme", true);
  localStorage.removeItem("Yohalighttheme");
  checkOptions();
  // html.style.removeProperty("--primary-rgb");
}
...
function checkOptions() {
  ...
  //RTL
  if (localStorage.getItem("Yohartl")) {
